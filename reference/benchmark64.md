...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.014     0.008              0          0        0
#> factor   1.000  0.857     1.500            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.014     0.008          0.006          0        0
#> factor   1.000  0.857     1.500          2.000        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.014     0.008          0.006      0.009        0
#> factor   1.000  0.857     1.500          2.000      1.333      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012  0.014     0.008          0.006      0.009     0.01
#> factor   1.000  0.857     1.500          2.000      1.333     1.20
#> 
...
#> SESSION        0.012  0.014     0.008          0.006      0.009
#>               allcache
#> cache             0.00
#> match(s, b)       0.00
#> s %in% b          0.00
...
#> SESSION           0.01
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN       0.0            NaN      0.000
#> match(s, b)      NaN    NaN       0.0            NaN      0.000
#> s %in% b         NaN    NaN       NaN            NaN      0.000
#> match(b, s)      NaN  0.000       NaN            NaN      0.000
#> b %in% s         NaN  0.000       NaN            NaN        NaN
#> match(b, b)      NaN  0.000       0.0            NaN      0.000
#> b %in% b           1  1.000       1.0            Inf      1.000
