...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.013     0.015              0          0        0
#> factor   1.000  0.846     0.733            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.013     0.015          0.009          0        0
#> factor   1.000  0.846     0.733          1.222        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.013     0.015          0.009       0.01        0
#> factor   1.000  0.846     0.733          1.222       1.10      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.013     0.015          0.009       0.01    0.008
#> factor   1.000  0.846     0.733          1.222       1.10    1.375
#> 
...
#> SESSION        0.011  0.013     0.015          0.009       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> SESSION            1  0.846     0.733          1.222        1.1
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
#> s %in% b           NaN
...
#> s %in% b       0.000  0.001     0.000          0.000       0.00
#> match(b, s)    0.000  0.000     0.000          0.000       0.00
#> b %in% s       0.000  0.000     0.000          0.000       0.00
#> match(b, b)    0.000  0.000     0.000          0.000       0.00
#> b %in% b       0.001  0.000     0.000          0.000       0.00
...
#> order(b)       0.001  0.001     0.000          0.000       0.00
#> rank(b)        0.001  0.000     0.000          0.000       0.00
...
#> cache          0.000  0.000     0.000          0.000       0.00
#> match(s, b)    0.000  0.001     0.000          0.000       0.00
#> s %in% b       0.000  0.001     0.001          0.000       0.00
#> match(b, s)    0.000  0.000     0.001          0.000       0.00
#> b %in% s       0.000  0.000     0.001          0.000       0.00
...
#> match(s, b)    0.000  0.001     0.000          0.001       0.00
#> s %in% b       0.000  0.001     0.001          0.001       0.00
#> match(b, s)    0.000  0.000     0.001          0.001       0.00
#> b %in% s       0.000  0.000     0.001          0.001       0.00
#> match(b, b)    0.000  0.000     0.001          0.001       0.00
#> b %in% b       0.001  0.000     0.000          0.001       0.00
#> duplicated(b)  0.000  0.000     0.000          0.001       0.00
#> unique(b)      0.000  0.000     0.000          0.000       0.00
#> table(b)       0.002  0.000     0.000          0.001       0.00
#> sort(b)        0.000  0.001     0.001          0.000       0.00
#> order(b)       0.001  0.001     0.000          0.003       0.00
...
#> match(s, b)      NaN  0.000       NaN          0.000        0.0
#> s %in% b         NaN  0.000     0.000          0.000        0.0
#> match(b, s)      NaN    NaN     0.000          0.000        0.0
#> b %in% s         NaN    NaN     0.000          0.000        0.0
#> match(b, b)      NaN    NaN     0.000          0.000        0.0
#> b %in% b           1    Inf       Inf          1.000        Inf
#> duplicated(b)    NaN    NaN       NaN          0.000        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1    Inf       Inf          2.000        Inf
...
#> rank(b)            1    Inf       Inf          1.000        Inf
#> quantile(b)      NaN  0.000     0.000            NaN        NaN
#> summary(b)       NaN  0.000     0.000            NaN        0.0
#> SESSION            1  0.846     0.733          1.222        1.1
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
