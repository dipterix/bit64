...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.015     0.011           0.01          0        0
#> factor   1.000  0.733     1.000           1.10        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.015     0.011           0.01      0.011        0
#> factor   1.000  0.733     1.000           1.10      1.000      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.015     0.011           0.01      0.011    0.007
#> factor   1.000  0.733     1.000           1.10      1.000    1.571
#> 
...
#> SESSION        0.011  0.015     0.011           0.01      0.011
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> s %in% b         NaN  0.000         0            NaN        NaN
#> match(b, s)      NaN  0.000       NaN            NaN        NaN
#> b %in% s         NaN  0.000       NaN            NaN        NaN
#> match(b, b)        1  1.000       Inf            Inf        Inf
#> b %in% b         NaN  0.000         0            NaN        NaN
#> duplicated(b)      1    Inf         1            Inf        Inf
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1  2.000         2            Inf        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN  0.000       NaN            NaN        NaN
#> rank(b)            1  1.000         1            Inf        Inf
...
#> table(b)           1  2.000         2            Inf        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN  0.000       NaN            0.0        NaN
#> rank(b)            1  1.000         1            1.0        Inf
#> quantile(b)      NaN    NaN         0            NaN        NaN
#> summary(b)         1  1.000         1            Inf        Inf
#> SESSION            1  0.733         1            1.1          1
#>               allcache
...
#> order(b)       0.000  0.001     0.000          0.004      0.000
#> rank(b)        0.001  0.001     0.001          0.001      0.001
#> quantile(b)    0.000  0.000     0.001          0.000      0.000
...
#> match(s, b)      NaN  0.000         0            0.0          0
#> s %in% b         NaN  0.000         0            0.0          0
#> match(b, s)      NaN  0.000       NaN            0.0          0
#> b %in% s         NaN  0.000       NaN            0.0          0
#> match(b, b)        1  1.000       Inf            1.0          1
#> b %in% b         NaN  0.000         0            0.0        NaN
#> duplicated(b)      1    Inf         1            Inf        Inf
#> unique(b)        NaN    NaN       NaN            0.0        NaN
#> table(b)           1  2.000         2            Inf        Inf
